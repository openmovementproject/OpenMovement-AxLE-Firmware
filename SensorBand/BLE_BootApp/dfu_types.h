...
#include "dfu_init.h" // KL: For DFU settings location
...
#define BOOTLOADER_SETTINGS_ADDRESS		 0x0003FC00				  /**< The field specifies the page location of the bootloader settings address. KL: Last page... */
...
// KL: Check our boot settings are correctly located in the UICR
STATIC_ASSERT(DFU_DEVICE_INFO_BASE == (NRF_UICR_BASE + 0x80));
