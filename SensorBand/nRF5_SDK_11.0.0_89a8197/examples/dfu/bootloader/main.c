...
// Variable elimination inhibit
extern uint8_t m_boot_settings[];
extern volatile uint32_t m_uicr_bootloader_start_address;

void PreventVariableElimination(uint32_t* arbitrary)
{
	*arbitrary = m_uicr_bootloader_start_address;
	if(*arbitrary)
	{
